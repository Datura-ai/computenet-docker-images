# Reviewing pull requests in `computenet-docker-images`
...
- After the base merges, the stacked PR is rebased onto `master`, checks re-run, and it is reviewed again only if
